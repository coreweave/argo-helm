...
{{ default (printf "%s.%s.%s.ingress.coreweave.cloud" .Values.fullnameOverride .Release.Namespace ((default .Values.global.region .Values.region)| lower | toString)) .Values.customExternalDnsName }}
{{- else -}}
{{ default (printf "%s.%s.%s.ingress.coreweave.cloud" .Release.Name .Release.Namespace ((default .Values.global.region .Values.region) | lower | toString)) .Values.customExternalDnsName }}
{{- end -}}
{{- end -}}
